...
class PlannerView(BaseController):
    ...
    def _inject_pomodoro(self):
        from src.views.components.learning_session_widget import LearningSessionWidget
